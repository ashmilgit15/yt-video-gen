...
async def mk():
    ...
    safe_chunk = "gravity is so strong\\,"
    all_filters = (
        zoom_filter
        + f",drawtext=text='{safe_chunk}':fontsize=60:fontcolor=white:borderw=3:bordercolor=black:x=(w-text_w)/2:y=h*0.75:enable='between(t,0,1.8)'"
    )
